  ...
  <div class="footer-29">
    <div class="container">
      <div class="d-grid grid-col-4 footer-top-29">
        <div class="footer-list-29 footer-1">
          ...
          <ul><?php
              ...
              <li><a href="mailto:" class="mail"><span class="fa fa-envelope-open-o"></span> <?php echo $row['Email']; ?></a></li><?php } ?>
          </ul>
      ...
      <div class="d-grid grid-col-2 bottom-copies">
        <!-- <p class="copy-footer-29">Designed & Developed By Amit Kumar Batham</p> -->
        <br>
        <p class="copy-footer-29">©Tezpur University. All rights reserved </p>
      </div>
    </div>
  </div>
  <!-- move top -->
