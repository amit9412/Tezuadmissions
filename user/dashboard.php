            ...
            <div class="card pull-up">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h4 align="center">You have not applied for addmision. Please fill the admission form. <section><h3><b><a href="programme-type.php">Go to Admission Portal</a></b></h3></section></h4>
                    </div>
                    <div>
         <i class="icon-file success font-large-2 float-right"></i>
                    </div>
